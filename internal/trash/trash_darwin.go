...
var _ Trasher = (*darwinTrasher)(nil)

// newTrasher creates a Darwin trash manager using the XDG Trash specification.
//
// Returns:
//   - Darwin trash implementation.
...
// Returns:
//   - An error if the move fails.
func (t *darwinTrasher) moveFile(src, dst string) error {
